	...
	return _createClass$15(Tooltip, [{
		...
		value: function render() {
			...
			return /*#__PURE__*/ import_react.createElement(TooltipBoundingBox, {
				...
				viewBox,
				wrapperStyle
			}, renderContent$1(content, _objectSpread$29(_objectSpread$29({}, this.props), {}, { payload: finalPayload })));
		}
	}]);
}(import_react.PureComponent);
...
function Surface(props) {
	...
	return /*#__PURE__*/ import_react.createElement("svg", _extends$22({}, filterProps(others, true, "svg"), {
...
var Symbols = function Symbols(_ref) {
	...
	var props = _objectSpread$27(_objectSpread$27({}, _objectWithoutProperties$11(_ref, _excluded$11)), {}, {
		type,
		size,
		sizeType
	});
...
var DefaultLegendContent = /*#__PURE__*/ function(_PureComponent) {
	function DefaultLegendContent() {
		...
		return _callSuper$10(this, DefaultLegendContent, arguments);
	}
	_inherits$10(DefaultLegendContent, _PureComponent);
	return _createClass$13(DefaultLegendContent, [
		{
			...
			value: function renderIcon(data) {
				...
				if (/*#__PURE__*/ import_react.isValidElement(data.legendIcon)) {
					var iconProps = _objectSpread$26({}, data);
		...
		},
		{
			...
			value: function renderItems() {
				...
				return payload.map(function(entry, i) {
					...
					var className = clsx(_defineProperty$29(_defineProperty$29({ "recharts-legend-item": true }, "legend-item-".concat(i), true), "inactive", entry.inactive));
					if (entry.type === "none") return null;
...
_defineProperty$29(DefaultLegendContent, "displayName", "Legend");
_defineProperty$29(DefaultLegendContent, "defaultProps", {
	iconSize: 14,
	layout: "horizontal",
	align: "center",
	verticalAlign: "middle",
...
var Legend = /*#__PURE__*/ function(_PureComponent) {
	function Legend() {
		...
		for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) args[_key] = arguments[_key];
		_this = _callSuper$9(this, Legend, [].concat(args));
		_defineProperty$28(_this, "lastBoundingBox", {
			width: -1,
			height: -1
		});
		return _this;
	...
	return _createClass$12(Legend, [
		...
		},
		{
			...
			value: function getBBoxSnapshot() {
				if (this.lastBoundingBox.width >= 0 && this.lastBoundingBox.height >= 0) return _objectSpread$25({}, this.lastBoundingBox);
				return {
					width: 0,
					height: 0
				};
		...
		},
		{
			...
			value: function getDefaultPosition(style) {
				...
				return _objectSpread$25(_objectSpread$25({}, hPos), vPos);
			}
		},
		{
			key: "render",
			value: function render() {
				...
				var outerStyle = _objectSpread$25(_objectSpread$25({
					position: "absolute",
					width: width || "auto",
					height: height || "auto"
				...
				}, renderContent(content, _objectSpread$25(_objectSpread$25({}, this.props), {}, { payload: getUniqPayload(payload, payloadUniqBy, defaultUniqBy) })));
			}
		}
	], [{
		key: "getWithHeight",
		value: function getWithHeight(item, chartWidth) {
			var layout = _objectSpread$25(_objectSpread$25({}, this.defaultProps), item.props).layout;
...
_defineProperty$28(Legend, "displayName", "Legend");
_defineProperty$28(Legend, "defaultProps", {
	iconSize: 14,
	layout: "horizontal",
	align: "center",
...
var Rectangle = function Rectangle(rectangleProps) {
	var props = _objectSpread$18(_objectSpread$18({}, defaultProps$3), rectangleProps);
...
var Trapezoid = function Trapezoid(props) {
	var trapezoidProps = _objectSpread$17(_objectSpread$17({}, defaultProps$2), props);
	var pathRef = (0, import_react.useRef)();
...
var Sector = function Sector(sectorProps) {
	var props = _objectSpread$16(_objectSpread$16({}, defaultProps$1), sectorProps);
...
function typeguardBarRectangleProps(_ref, props) {
	...
	return _objectSpread$14(_objectSpread$14(_objectSpread$14(_objectSpread$14(_objectSpread$14({}, props), option), x ? { x } : {}), y ? { y } : {}), {}, {
		height,
		width,
		name: props.name,
		radius: props.radius
	...
	return _createClass$10(Bar, [
		{
			...
			value: function renderRectanglesStatically(data) {
				...
				return data && data.map(function(entry, i) {
					...
					var props = _objectSpread$13(_objectSpread$13(_objectSpread$13({}, baseProps), entry), {}, {
						isActive,
						option,
						index: i,
						dataKey,
			...
			value: function renderRectanglesWithAnimation() {
				...
				return /*#__PURE__*/ import_react.createElement(es6_default, {
					...
					var stepData = data.map(function(entry, index) {
						...
						return _objectSpread$13(_objectSpread$13({}, entry), {}, { width: w });
					});
		...
		},
		{
			...
			value: function renderBackground() {
				...
				return data.map(function(entry, i) {
					...
					var props = _objectSpread$13(_objectSpread$13(_objectSpread$13(_objectSpread$13(_objectSpread$13({}, rest), {}, { fill: "#eee" }, background), backgroundProps), adaptEventsOfChild(_this4.props, entry, i)), {}, {
...
_defineProperty$16(Bar, "getComposedData", function(_ref2) {
	...
	var itemDefaultProps = item.type.defaultProps;
	var itemProps = itemDefaultProps !== void 0 ? _objectSpread$13(_objectSpread$13({}, itemDefaultProps), item.props) : item.props;
	...
	return _objectSpread$13({
		data: displayedData.map(function(entry, index) {
			...
			return _objectSpread$13(_objectSpread$13(_objectSpread$13({}, entry), {}, {
				x,
				y,
				width,
				height,
...
var formatAxisMap = function formatAxisMap(props, axisMap, offset, axisType, chartName) {
	...
	return ids.reduce(function(result, id) {
		...
		var ticks = getTicksOfScale(scale, _objectSpread$12(_objectSpread$12({}, axis), {}, { realScaleType }));
		if (axisType === "xAxis") {
		...
		var finalAxis = _objectSpread$12(_objectSpread$12(_objectSpread$12({}, axis), ticks), {}, {
			realScaleType,
			x,
			y,
			scale,
		...
		return _objectSpread$12(_objectSpread$12({}, result), {}, _defineProperty$15({}, id, finalAxis));
	}, {});
};
...
var createLabeledScales = function createLabeledScales(options) {
	var scales = Object.keys(options).reduce(function(res, key) {
		return _objectSpread$12(_objectSpread$12({}, res), {}, _defineProperty$15({}, key, ScaleHelper.create(options[key])));
	}, {});
	return _objectSpread$12(_objectSpread$12({}, scales), {}, {
	...
	return _createClass$8(CartesianAxis, [
		...
		},
		{
			...
			value: function renderAxisLine() {
				...
				return /*#__PURE__*/ import_react.createElement("line", _extends$11({}, props, { className: clsx("recharts-cartesian-axis-line", (0, import_get.default)(axisLine, "className")) }));
			}
		},
		{
			key: "renderTicks",
			value: function renderTicks(ticks, fontSize, letterSpacing) {
				...
				var items = finalTicks.map(function(entry, i) {
					...
					}, adaptEventsOfChild(_this2.props, entry, i)), tickLine && /*#__PURE__*/ import_react.createElement("line", _extends$11({}, tickLineProps, lineCoord, { className: clsx("recharts-cartesian-axis-tick-line", (0, import_get.default)(tickLine, "className")) })), tick && CartesianAxis.renderTickItem(tick, tickProps, "".concat((0, import_isFunction.default)(tickFormatter) ? tickFormatter(entry.value, i) : entry.value).concat(unit || "")));
				});
		...
		value: function renderTickItem(option, props, value) {
			...
			else tickItem = /*#__PURE__*/ import_react.createElement(Text, _extends$11({}, props, { className: "recharts-cartesian-axis-tick-value" }), value);
			return tickItem;
		}
	}]);
}(import_react.Component);
_defineProperty$13(CartesianAxis, "displayName", "CartesianAxis");
_defineProperty$13(CartesianAxis, "defaultProps", {
	x: 0,
	y: 0,
	width: 0,
	height: 0,
...
function CartesianGrid(props) {
	...
	if ((!horizontalPoints || !horizontalPoints.length) && (0, import_isFunction.default)(horizontalCoordinatesGenerator)) {
		...
		warn(Array.isArray(generatorResult), "horizontalCoordinatesGenerator should return Array but instead it returned [".concat(_typeof$12(generatorResult), "]"));
	...
	if ((!verticalPoints || !verticalPoints.length) && (0, import_isFunction.default)(verticalCoordinatesGenerator)) {
		...
		warn(Array.isArray(_generatorResult), "verticalCoordinatesGenerator should return Array but instead it returned [".concat(_typeof$12(_generatorResult), "]"));
	...
	}), /*#__PURE__*/ import_react.createElement(HorizontalGridLines, _extends$10({}, propsIncludingDefaults, {
		offset,
		horizontalPoints,
		xAxis,
		yAxis
	})), /*#__PURE__*/ import_react.createElement(VerticalGridLines, _extends$10({}, propsIncludingDefaults, {
		offset,
		verticalPoints,
		xAxis,
		yAxis
	})), /*#__PURE__*/ import_react.createElement(HorizontalStripes, _extends$10({}, propsIncludingDefaults, { horizontalPoints })), /*#__PURE__*/ import_react.createElement(VerticalStripes, _extends$10({}, propsIncludingDefaults, { verticalPoints })));
}
...
_defineProperty$11(XAxis, "displayName", "XAxis");
_defineProperty$11(XAxis, "defaultProps", {
	allowDecimals: true,
	hide: false,
	orientation: "bottom",
	width: 0,
...
_defineProperty$10(YAxis, "displayName", "YAxis");
_defineProperty$10(YAxis, "defaultProps", {
	allowDuplicatedCategory: true,
	allowDecimals: true,
	hide: false,
	orientation: "left",
...
var Dot = function Dot(props) {
	...
	if (cx === +cx && cy === +cy && r === +r) return /*#__PURE__*/ import_react.createElement("circle", _extends$7({}, filterProps(props, false), adaptEventHandlers(props), {
		className: layerClass,
		cx,
		cy,
		r
...
var generatePrefixStyle = function generatePrefixStyle(name, value) {
	...
	var result = PREFIX_LIST.reduce(function(res, entry) {
		return _objectSpread$8(_objectSpread$8({}, res), {}, _defineProperty$9({}, entry + camelName, value));
	}, {});
	result[name] = value;
	return result;
};
...
var getPath$1 = function getPath(_ref) {
	...
	if (Array.isArray(baseLine)) {
		...
		var areaPoints = formatPoints.map(function(entry, index) {
			return _objectSpread$3(_objectSpread$3({}, entry), {}, { base: formatBaseLine[index] });
		});
...
var Curve = function Curve(props) {
	...
	return /*#__PURE__*/ import_react.createElement("path", _extends$2({}, filterProps(props, false), adaptEventHandlers(props), {
