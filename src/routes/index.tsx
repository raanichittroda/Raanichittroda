      ...
      <section className="bg-background py-16 sm:py-24 border-t border-border">
        <div className="mx-auto max-w-4xl px-6 sm:px-8">
          <div className="prose prose-gold max-w-none text-muted-foreground space-y-8 text-sm sm:text-base leading-relaxed">
            ...
            <div className={isExpanded ? "space-y-8" : "hidden"}>
              <div>
            ...
            <div className="text-center pt-4 border-t border-border/40 mt-6">
              <button
                type="button"
                onClick={() => setIsExpanded(!isExpanded)}
                className="inline-flex items-center justify-center gap-2 border border-border px-8 py-3.5 text-[0.72rem] uppercase tracking-[0.28em] text-foreground hover:border-gold hover:text-gold transition duration-300"
              >
